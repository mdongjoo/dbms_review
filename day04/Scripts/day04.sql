...
-- BOOK , MEMBER 테이블 실습하기 
--회원 정보 추가 (1,'홍길동', 22, '010-1234-1234','서울시')
--회원 정보 추가 (2,'짱구', 22, '010-1234-5678','서울시')
--회원 정보 추가 (3,'맹구', 20, '010-2222-1234','경기도')
--회원 정보 추가 (4,'철수', 20, '010-3333-1234','경기도')
SELECT * FROM TBL_MEMBER ;

INSERT INTO TBL_MEMBER 
VALUES('1','홍길동', 22, '010-1234-1234','서울시');

INSERT INTO TBL_MEMBER 
VALUES('2','짱구', 22, '010-1234-5678','서울시');

INSERT INTO TBL_MEMBER 
VALUES('3','맹구', 20, '010-2222-1234','경기도');

INSERT INTO TBL_MEMBER 
VALUES('4','철수', 20, '010-3333-1234','경기도');
--책 정보 추가 
--1, '셜록' , '추리', NULL
--2, 'DBMS완전정복', 'IT' , NULL
--3,'인문학개론' ,'인문학' , NULL
...
INSERT INTO TBL_BOOK 
VALUES(2, 'DBMS완전정복', 'IT' , NULL);

INSERT INTO TBL_BOOK 
VALUES(3,'인문학개론' ,'인문학' , NULL);
--회원 이름 수정 
--회원번호가 2인 것을 유리로 설정 

UPDATE TBL_MEMBER 
SET MEMBER_NAME = '유리'
WHERE MEMBER_SERIAL_NUMBER = '2';

--책 대여하기 
--MEMBER_NUMBER = 3 -> BOOK_NUMBER =1 
--MEMBER_NUMBER = 3 -> BOOK_NUMBER =2 
--MEMBER_NUMBER = 2 -> BOOK_NUMBER =3 
UPDATE TBL_BOOK 
SET MEMBER_SERIAL_NUMBER = 3
WHERE BOOK_SERIAL_NUMBER  = 1;

UPDATE TBL_BOOK 
SET MEMBER_SERIAL_NUMBER = 3
WHERE BOOK_SERIAL_NUMBER  = 2;

UPDATE TBL_BOOK 
SET MEMBER_SERIAL_NUMBER = 2
WHERE BOOK_SERIAL_NUMBER  = 3;
--책 대여한 회원번호 수정 
-- MEMBER_NUMBER = 4 -> MEMBER_NUMBER = 3
-- PK값이 중복되므로 X


--회원 삭제 
--NULL값으로 변경후 BOOK_NUMBER = 3 
UPDATE TBL_MEMBER 
SET MEMBER
